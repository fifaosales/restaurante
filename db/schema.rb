...
ActiveRecord::Schema.define(:version => 20100818215222) do
  ...
  create_table "padarias", :force => true do |t|
    t.string   "nome",          :limit => 80
    t.string   "endereco"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "qualificacoes", ["valor_gasto"], :name => "index_qualificacoes_on_valor_gasto"
